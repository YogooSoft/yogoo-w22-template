<template>
    <el-alert title="主页面>>>二级路由页面03" style="margin-bottom: 10px"  type="warning" :closable="false" />
    ...
    export default defineComponent({
      ...
      Search,
        ...
        methods: {
            ...
            handleClick() {
                this.$router.push("/page/insideRouter/c3/cc3/index");
                // this.$router.push("/level/level-2_01/level-3_01/index");
            },
            teamInfo(value) {
                this.psnTableInfo['cc3'] = value
            },
        ...
        mounted() {
            ...
            try {
                if(this.teamInfoBKData['c3']){
                    this.psnTableInfo = this.teamInfoBKData['c3'];
                }
        ...
        watch: {
            psnTableInfo: {
                handler(newValue, oldValue) {
                    ...
                    this.$emit('getTeamInfoC3', newValue)
