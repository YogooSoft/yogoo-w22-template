    ...
    <div class="flex-1">
      ...
      >
        <el-form-item label="微信原始ID" prop="originalID">
          <el-input
            v-model="WeChatUpdateRuleForm.originalID"
            placeholder="请输入微信原始ID"
          />
        </el-form-item>
        <el-form-item label="微信账号" prop="account">
          <el-input
            v-model="WeChatUpdateRuleForm.account"
            placeholder="请输入微信账号"
          />
        </el-form-item>
        <el-form-item label="开发者ID" prop="appID">
          <el-input
            v-model="WeChatUpdateRuleForm.appID"
            placeholder="请输入开发者ID"
          />
        </el-form-item>
        <el-form-item label="开发者密码" prop="appSecret">
          <el-input
            v-model="WeChatUpdateRuleForm.appSecret"
            placeholder="请输入开发者密码"
          />
        </el-form-item>
        <el-form-item label="公众号名称" prop="name">
          <el-input
            v-model="WeChatUpdateRuleForm.name"
            placeholder="请输入公众号名称"
          />
        </el-form-item>

        <el-form-item label="账号类型" prop="type">
          <el-select v-model="WeChatUpdateRuleForm.type" placeholder="账号类型">
