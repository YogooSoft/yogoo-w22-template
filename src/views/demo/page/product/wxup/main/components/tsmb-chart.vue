...
chartOption.series[0].data = new Array(7)
  .fill(1)
  .map(() => parseInt(String((Math.random() / 10 + 1) * 300)));
chartOption.series[1].data = new Array(7).fill(400);
</script>
