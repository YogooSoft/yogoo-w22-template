<template>
  <div class="toolsbar">
    <el-button plain @click="renderSideBySide()">显示行内对比</el-button>
  </div>
  <div class="fix">
...
let renderSideBySideStatus = false
function renderSideBySide(){
  renderSideBySideStatus =  !renderSideBySideStatus;
  editorDiff.updateOptions({renderSideBySide: !renderSideBySideStatus});  
}
