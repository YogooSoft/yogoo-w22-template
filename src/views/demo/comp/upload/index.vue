<template>
  ...
  <page-wrapper title="覆盖前一个文件" content="">
    <collapse-container
      class="cl-mb-10"
      title="覆盖前一个文件"
      :can-expan="true"
  ...
  <page-wrapper title="用户头像" content="">
    <collapse-container
      class="cl-mb-10"
      title="用户头像"
      :can-expan="true"
  ...
  <page-wrapper title="照片墙" content="">
    <collapse-container
      class="cl-mb-10"
      title="照片墙"
      :can-expan="true"
  ...
  <page-wrapper title="自定义缩略图" content="">
    <collapse-container
      class="cl-mb-10"
      title="自定义缩略图"
    ...
    >
      ...
      <el-dialog v-model="ZDYSLTdialogVisible">
        <img w-full :src="ZDYSLTdialogImageUrl" alt="Preview Image" style="max-width: 100%"/>
      </el-dialog>
  ...
  <page-wrapper title="图片列表缩略图" content="">
    <collapse-container
      class="cl-mb-10"
      title="图片列表缩略图"
      :can-expan="true"
  ...
  <page-wrapper title="上传文件列表控制" content="">
    <collapse-container
      class="cl-mb-10"
      title="上传文件列表控制"
      :can-expan="true"
  ...
  <page-wrapper title="拖拽上传" content="">
    <collapse-container
      class="cl-mb-10"
      title="拖拽上传"
      :can-expan="true"
  ...
  <page-wrapper title="手动上传" content="">
    <collapse-container
      class="cl-mb-10"
      title="手动上传"
      :can-expan="true"
...
<script lang="ts" setup>
  ...
  const handleRemoveTPLBSLT: UploadProps['onRemove'] = (uploadFile, uploadFiles) => {
    console.log(uploadFile, uploadFiles)
  };
  ...
  const handleChangeSCWJLBKZ: UploadProps['onChange'] = (uploadFile, uploadFiles) => {
